...
namespace TheGapFillers.Portrack.Models.Application
{
    public class Portfolio
    {
        ...
        public void SetPortfolioData(
            ...
            IEnumerable<HistoricalPrice> historicalPrices,
            IEnumerable<Dividend> dividends)
        {
            PortfolioData = new PortfolioData
            {
                ...
                HistoricalPrices = CalculatePortfolioHistoricalPrices(historicalPrices)
            };
        }
        ...
        private List<HistoricalPrice> CalculatePortfolioHistoricalPrices(IEnumerable<HistoricalPrice> historicalPrices)
        {
            ...
            { 
                ...
                {
                    Holding holding = historicalHoldings.SingleOrDefault(h => h.Instrument.Ticker == dailyTransaction.Ticker);
                    if (holding == null)
                    {
                    ...
                    {
                        holding.Shares += dailyTransaction.Type == TransactionType.Buy ? dailyTransaction.Shares : -dailyTransaction.Shares;
                    }
                }
